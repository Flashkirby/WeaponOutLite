...
{
    // TODO: WIP, this is currently a dupe of an existing pose
    public class StanceRapierHold : OnWaistSheathe
    {
        public override int GetID() => DrawItemPoseID.StanceRapierHold;
